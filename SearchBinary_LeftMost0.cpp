    ...
    static int indexOf( const vector< Value >& valuesVec, Value val ) {
        ...
        while ( low <= high ) {
            ...
            if ( val > valuesVec[ mid ] ) {
                ...
                // going left by setting high = mid ( instead of simply return
                // mid ) to see if we can find a valuesVec[ mid ] that has
                // smaller mid.
                //
                // At the end, low will either contain the lowest mid, or not
                // containing mid at all. We have to check valuesVec[ low ]
                // for that.
                //
...
int main( int argc, char ** argv ) {
    ...
    cout << "DEBUG : BinarySearchLeftMost::indexOf( 0 ) == 0 : " << BinarySearchLeftMost< int >::indexOf( intArr, 0 ) << endl;
    cout << "DEBUG : BinarySearchLeftMost::indexOf( 5 ) == 6 : " << BinarySearchLeftMost< int >::indexOf( intArr, 5 ) << endl;
    cout << "DEBUG : BinarySearchLeftMost::indexOf( 10 ) == 14 : " << BinarySearchLeftMost< int >::indexOf( intArr, 10 ) << endl;
    cout << "DEBUG : BinarySearchLeftMost::indexOf( 4 ) == 5 : " << BinarySearchLeftMost< int >::indexOf( intArr, 4 ) << endl;
    cout << "DEBUG : BinarySearchLeftMost::indexOf( 50 ) == -1 : " << BinarySearchLeftMost< int >::indexOf( intArr, 50 ) << endl;
