...
int main( int argc, char ** argv ) {
    ...
    cout << "DEBUG : BinarySearchLeftMost::indexOf( 0 ) : " << BinarySearchLeftMost< int >::indexOf( intArr, 0 ) << endl;
    cout << "DEBUG : BinarySearchLeftMost::indexOf( 5 ) : " << BinarySearchLeftMost< int >::indexOf( intArr, 5 ) << endl;
    cout << "DEBUG : BinarySearchLeftMost::indexOf( 10 ) : " << BinarySearchLeftMost< int >::indexOf( intArr, 10 ) << endl;
    cout << "DEBUG : BinarySearchLeftMost::indexOf( 4 ) : " << BinarySearchLeftMost< int >::indexOf( intArr, 4 ) << endl;
    cout << "DEBUG : BinarySearchLeftMost::indexOf( 50 ) : " << BinarySearchLeftMost< int >::indexOf( intArr, 50 ) << endl;
