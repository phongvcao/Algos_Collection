...
public:
    ...
    static Value getMajorityVote( const vector< Value >& valuesVec ) {
        int count = 0;
        Value candidate;

        for ( int i = 0; i < valuesVec.size(); ++i ) {
            if ( count == 0 ) {
                candidate = valuesVec[ i ];
            }

            count += ( candidate == valuesVec[ i ] ) ? 1 : -1;
        }
        return candidate;
    }
...
int main( int argc, char ** argv ) {
    ...
    vector< int > intArr = { 7, 7, 5, 7, 5, 1, 5, 7, 5, 5, 7, 7, 7, 7, 7, 7 };
    cout << "DEBUG : majority : " << BoyerMooreMajorityVote< int >::getMajorityVote( intArr ) << endl;
    
    intArr = { 7, 7, 5, 7, 5, 1, 5, 7, 5, 5, 7, 7, 5, 5, 5, 5 };
    cout << "DEBUG : majority : " << BoyerMooreMajorityVote< int >::getMajorityVote( intArr ) << endl;
