...
int main( int argc, char ** argv ) {
    ...
    DFSCycle dfsCycle( graph );
    cout << "DEBUG: dfsCycle.hasCycle(): \n" << dfsCycle.hasCycle() << endl;
    cout << "DEBUG: dfsCycle.getCycle(): \n" << endl;
    stack< int > cycleStack = dfsCycle.getCycle();
