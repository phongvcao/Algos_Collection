...
int main( int argc, char ** argv ) {
    ...
    cout << "DEBUG : BinarySearch::indexOf( 5 ) : " << BinarySearch< int >::indexOf( intArr, 5 ) << endl;
    cout << "DEBUG : BinarySearch::indexOf( 4 ) : " << BinarySearch< int >::indexOf( intArr, 4 ) << endl;
    cout << "DEBUG : BinarySearch::indexOf( 50 ) : " << BinarySearch< int >::indexOf( intArr, 50 ) << endl;
