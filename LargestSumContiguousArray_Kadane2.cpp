...
public:
    ...
    static int getLargestSumContiguousArray( const vector< int >& intVec ) {
        int maxSum = intVec[ 0 ];
        int curSum = intVec[ 0 ];

        for ( int i = 0; i < intVec.size(); i++ ) {
            curSum = max( intVec[ i ], curSum + intVec[ i ] );
...
int main( int argc, char ** argv ) {
    ...
    cout << "DEBUG : getLargestSumContiguousArray() : " << LargestSumKadane::getLargestSumContiguousArray( intVec ) << endl;
