...
public:
    static int indexOf( const vector< Value >& valuesVec, Value val ) {
        auto foundIter = upper_bound( valuesVec.begin(), valuesVec.end(), val );
        if ( foundIter - 1 != valuesVec.end() && *( foundIter - 1 ) == val ) {
            return foundIter - 1 - valuesVec.begin();
        }
        return -1;
    }
...
int main( int argc, char ** argv ) {
    ...
    cout << "DEBUG : BinarySearchUpperBound::indexOf( 0 ) : " << BinarySearchUpperBound< int >::indexOf( intArr, 0 ) << endl;
    cout << "DEBUG : BinarySearchUpperBound::indexOf( 5 ) : " << BinarySearchUpperBound< int >::indexOf( intArr, 5 ) << endl;
    cout << "DEBUG : BinarySearchUpperBound::indexOf( 10 ) : " << BinarySearchUpperBound< int >::indexOf( intArr, 10 ) << endl;
    cout << "DEBUG : BinarySearchUpperBound::indexOf( 4 ) : " << BinarySearchUpperBound< int >::indexOf( intArr, 4 ) << endl;
    cout << "DEBUG : BinarySearchUpperBound::indexOf( 50 ) : " << BinarySearchUpperBound< int >::indexOf( intArr, 50 ) << endl;
