...
//
// Time Complexity : O( log( N ) ) for RandomAccessIterator
//                   O( N ) for Non-RandomAccessIterator
// Space Complexity : O( 1 )
//

template< typename Value >
class BinarySearchLeftMostLowerBound {
public:
    static int indexOf( const vector< Value >& valuesVec, Value val ) {
        auto foundIter = lower_bound( valuesVec.begin(), valuesVec.end(), val );
        if ( foundIter != valuesVec.end() && *foundIter == val ) {
            return foundIter - valuesVec.begin();
        }
        return -1;
    }
...
int main( int argc, char ** argv ) {
    ...
    cout << "DEBUG : BinarySearchLeftMostLowerBound::indexOf( 0 ) : " << BinarySearchLeftMostLowerBound< int >::indexOf( intArr, 0 ) << endl;
    cout << "DEBUG : BinarySearchLeftMostLowerBound::indexOf( 5 ) : " << BinarySearchLeftMostLowerBound< int >::indexOf( intArr, 5 ) << endl;
    cout << "DEBUG : BinarySearchLeftMostLowerBound::indexOf( 10 ) : " << BinarySearchLeftMostLowerBound< int >::indexOf( intArr, 10 ) << endl;
    cout << "DEBUG : BinarySearchLeftMostLowerBound::indexOf( 4 ) : " << BinarySearchLeftMostLowerBound< int >::indexOf( intArr, 4 ) << endl;
    cout << "DEBUG : BinarySearchLeftMostLowerBound::indexOf( 50 ) : " << BinarySearchLeftMostLowerBound< int >::indexOf( intArr, 50 ) << endl;
