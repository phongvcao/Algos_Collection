...
int main( int argc, char ** argv ) {
    ...
    cout << sList << endl << endl;
    
    cout << "DEBUG : Reverse ( recursively ) : " << endl;
    sList.reverse();
    cout << sList << endl;
    
    cout << "DEBUG : Reverse ( recursively ) - AGAIN : " << endl;
    sList.reverse();
    cout << sList << endl;
    ...
    cout << "DEBUG : Reverse ( iteratively ) - AGAIN : " << endl;
    sList.reverse( false );
    cout << sList << endl << endl;

    cout << "DEBUG : Erase ( iteratively ) : " << intArr[ 5 ] << " : " << endl;
    sList.erase( intArr[ 5 ] );
    cout << sList << endl;

    for ( int i = 0; i < intArr.size() - 1; ++i ) {
        cout << "DEBUG : Erase ( iteratively ) : " << intArr[ i ] << " : " << endl;
        sList.erase( intArr[ i ] );
        cout << sList << endl;
    }
