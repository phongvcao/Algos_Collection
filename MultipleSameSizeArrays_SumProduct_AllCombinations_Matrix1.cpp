...
public:
    unordered_map< int, int > countAllSumCombinations( const vector< vector< int > >& vectorsList, int start, int end ) {
        unordered_map< int, int > count( { { 0, 1 } } );

        for ( int i = start; i < end; ++i ) {
            unordered_map< int, int > tempCount;
            for ( auto value : vectorsList[ i ] ) {
    ...
    unordered_map< int, int > countAllProductCombinations( const vector< vector< int > >& vectorsList, int start, int end ) {
