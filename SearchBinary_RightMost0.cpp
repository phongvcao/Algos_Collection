...
int main( int argc, char ** argv ) {
    ...
    cout << "DEBUG : BinarySearchRightMost::indexOf( 0 ) : " << BinarySearchRightMost< int >::indexOf( intArr, 0 ) << endl;
    cout << "DEBUG : BinarySearchRightMost::indexOf( 5 ) : " << BinarySearchRightMost< int >::indexOf( intArr, 5 ) << endl;
    cout << "DEBUG : BinarySearchRightMost::indexOf( 10 ) : " << BinarySearchRightMost< int >::indexOf( intArr, 10 ) << endl;
    cout << "DEBUG : BinarySearchRightMost::indexOf( 4 ) : " << BinarySearchRightMost< int >::indexOf( intArr, 4 ) << endl;
    cout << "DEBUG : BinarySearchRightMost::indexOf( 50 ) : " << BinarySearchRightMost< int >::indexOf( intArr, 50 ) << endl;
